...
import (
	...
	"github.com/petewall/eink-radiator-image-source-nasa-image-of-the-day/cmd"
	...
	"github.com/petewall/eink-radiator-image-source-nasa-image-of-the-day/pkg/pkgfakes"
)
...
var _ = Describe("Generate", func() {
	...
	It("generates an image", func() {
		...
		By("defaulting to writing to nasa-image-of-the-day.png", func() {
			...
			Expect(filename).To(Equal("nasa-image-of-the-day.png"))
