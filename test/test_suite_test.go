...
var _ = BeforeSuite(func() {
	...
	imageSourcePath, err = gexec.Build(
		"github.com/petewall/eink-radiator-image-source-nasa-image-of-the-day",
		"-ldflags",
		"-X github.com/petewall/eink-radiator-image-source-nasa-image-of-the-day/cmd.Version=1.2.3",
	)
